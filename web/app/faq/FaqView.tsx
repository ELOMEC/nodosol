...
export function FaqView() {
  return (
    <main id="main-content" style={SHELL}>
      <header style={HEADER}>
        <Link href="/" style={LOGO_LINK}>
          <span style={LOGO_MARK}>n</span>
          <span style={LOGO_WORD}>nodosol</span>
        </Link>
        <Link href="/" style={BACK_LINK}>
          ← Home
        </Link>
      </header>
      ...
      <article style={ARTICLE}>
        ...
        <footer style={FOOTER}>
          ...
          ·{" "}
          <a
            href="https://github.com/ELOMEC/nodosol/blob/main/docs/CREATOR_GUIDE.md"
            target="_blank"
            rel="noreferrer"
            style={LINK}
          >
          ...
          ·{" "}
          <a
            href="https://github.com/ELOMEC/nodosol/blob/main/docs/BUYER_GUIDE.md"
            target="_blank"
            rel="noreferrer"
            style={LINK}
          >
          ...
          ·{" "}
          <a
            href="https://github.com/ELOMEC/nodosol/blob/main/docs/INTEGRATIONS_GUIDE.md"
            target="_blank"
            rel="noreferrer"
            style={LINK}
          >
...
const LOGO_LINK: React.CSSProperties = {
  display: "flex",
  alignItems: "center",
  gap: "0.55rem",
  textDecoration: "none",
...
const LOGO_WORD: React.CSSProperties = {
  fontSize: "1.1rem",
  fontWeight: 600,
...
const DETAILS: React.CSSProperties = {
  ...
  background: "var(--shell-card-bg, #11141a)",
};
