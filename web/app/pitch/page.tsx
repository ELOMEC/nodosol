...
export default function PitchPage() {
  return (
    <PublicPageShell active="pitch">
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 0 1rem" }}>
...
function DataPoint({ headline, blurb }: { headline: string; blurb: string }) {
  return (
    ...
    >
      <div style={{ fontSize: "1.85rem", fontWeight: 600, letterSpacing: 0, marginBottom: "0.35rem" }}>{headline}</div>
