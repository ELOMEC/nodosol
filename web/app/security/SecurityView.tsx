...
const SECURITY_RUNBOOK_URL = `${GITHUB_URL}/blob/main/docs/SECURITY_RUNBOOK.md`;
        ...
        <Section title="Off-chain hardening">
          <ul style={UL}>
            <li>
              ...
              Supabase write (HS256, 15-minute TTL); rotation runbook in{" "}
              <a href={SECURITY_RUNBOOK_URL} target="_blank" rel="noreferrer" style={LINK}>SECURITY_RUNBOOK.md</a>.
            </li>
            <li>
