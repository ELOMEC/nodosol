...
export function EventsView() {
  ...
  return (
    <>
      <header style={HERO}>
        <div>
          <span style={EYEBROW}>Ticketing studio</span>
          <h1 style={H1}>
            Events
          </h1>
          <p style={SUB}>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "1rem 1.1rem 1.1rem", display: "flex", flexDirection: "column", flex: 1 }}>
        ...
        >
          <div style={{ fontSize: "1rem", fontWeight: 800, marginBottom: "0.15rem", lineHeight: 1.3 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.85rem" }}>
            <div>
              <div style={{ fontSize: "1.2rem", fontWeight: 800 }}>${event.price.toFixed(2)}</div>
              <div style={{ fontSize: "0.72rem", color: "var(--shell-faint)" }}>per ticket · USDC</div>
            </div>
            <div style={{ textAlign: "right" }}>
              <div style={{ fontSize: "0.82rem", fontWeight: 800, color: "#0369a1" }}>{left} left</div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.85rem", gap: "1rem" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.25rem" }}>
            <div style={{ fontSize: "1.05rem", fontWeight: 800 }}>{event.name || "(unnamed)"}</div>
