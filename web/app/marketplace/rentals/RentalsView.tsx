...
export function RentalsView() {
  ...
  return (
    <>
      <header style={HERO}>
        <div>
          <span style={EYEBROW}>Recurring rentals</span>
          <h1 style={H1}>
            Rentals
          </h1>
          <p style={SUB}>
    ...
    >
      ...
      >
        ...
        <div style={{ padding: "0.85rem 1rem", flex: 1, display: "flex", flexDirection: "column", gap: "0.35rem" }}>
          <div style={{ fontSize: "0.95rem", fontWeight: 800, lineHeight: 1.3 }}>{title}</div>
          {plan.metadata?.location?.address && (
            <div style={{ fontSize: "0.75rem", color: "#6b7280" }}>
              {plan.metadata.location.address}
            </div>
          )}
          <div style={{ fontSize: "0.82rem", color: "var(--shell-fg, #111827)", fontWeight: 800, marginTop: "0.15rem" }}>
