  ...
  return (
    <>
      <header style={{ marginBottom: "1.25rem" }}>
        ...
        <h1 style={{ fontSize: "1.45rem", fontWeight: 600, letterSpacing: 0, marginTop: "0.35rem", marginBottom: "0.3rem" }}>
  ...
  return (
    <>
      <header style={{ marginBottom: "1rem" }}>
        <h1 style={{ fontSize: "1.45rem", fontWeight: 600, letterSpacing: 0 }}>{title}</h1>
      </header>
      {children}
    </>
  );
