...
export function OtcView() {
  ...
  return (
    <>
      <header style={HERO}>
        <div>
          <span style={EYEBROW}>Private deal desk</span>
          <h1 style={H1}>
            OTC deals
          </h1>
          <p style={SUB}>
        ...
        <button
          ...
          style={{
            background: myAssets.length === 0 ? "var(--shell-border-strong)" : "#0f172a",
            color: myAssets.length === 0 ? "var(--shell-faint)" : "#fff",
            padding: "0.68rem 1rem",
            borderRadius: 999,
            fontSize: "0.88rem",
            fontWeight: 800,
            border: myAssets.length === 0 ? "1px solid var(--shell-border-strong)" : "1px solid #0f172a",
    ...
    >
      ...
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.3rem" }}>
          <div style={{ fontSize: "0.98rem", fontWeight: 800 }}>{deal.assetName ?? "(unnamed)"}</div>
          <span style={{ fontSize: "0.72rem", color: "var(--shell-muted)", background: "var(--shell-divider)", padding: "0.16rem 0.5rem", borderRadius: 999, fontWeight: 800 }}>
            {categoryLabel}
          </span>
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 999,
        border: active ? "1px solid #0f172a" : "1px solid var(--shell-border)",
        background: active ? "#0f172a" : "#fff",
        color: active ? "#fff" : "var(--shell-muted)",
        fontSize: "0.86rem",
        fontWeight: 800,
        cursor: "pointer",
      }}
  ...
  return (
    <>
      <header style={HERO}>
        <div>
        <span style={EYEBROW}>Private deal desk</span>
        <h1 style={H1}>OTC deals</h1>
        <p style={SUB}>Peer-to-peer negotiated trades with escrow.</p>
        </div>
      </header>
      <div
        style={{
